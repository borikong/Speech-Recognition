...
import static com.google.cloud.android.speech.DailyTest.MainActivity.pronounciationQ;
import static com.google.cloud.android.speech.DailyTest.MainActivity.speedQ;

public class StudyPronounciationActivity extends AppCompatActivity {
    TextView tv;
    int Score;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_study_pronounciation);
        tv=(TextView) findViewById(R.id.tv) ;

        Intent intent=getIntent();
        Score=intent.getIntExtra("PronounciationScore",Score); //인트형받기
    ...
    public void searchRecord(String c_score){
        ...
        Cursor c2= DailyTestQuestionDB.db.rawQuery("select question from "+ pronounciationQ+" where score<?", where);
