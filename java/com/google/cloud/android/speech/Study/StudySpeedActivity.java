...
public class StudySpeedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_study_speed);

        tv=(TextView) findViewById(R.id.tv) ;

        Intent intent=getIntent();
        Score=intent.getIntExtra("SpeedScore",Score); //인트형받기
    ...
    public void searchRecord(String c_score){
        ...
        Cursor c2= DailyTestQuestionDB.db.rawQuery("select question from "+ speedQ +" where score<?", where);
