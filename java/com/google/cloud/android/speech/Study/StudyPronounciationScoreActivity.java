...
public class StudyPronounciationScoreActivity extends AppCompatActivity {
    TextView tv;
    EditText edt;
    Button okBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_study_pronounciation_score);
        ...
        okBtn.setOnClickListener(new View.OnClickListener(){ //확인버튼 누르고 스터디 속도 영역 가기
            ...
            public void onClick(View v) {
                Intent intent= new Intent(getApplication(), StudyPronounciationActivity.class);
                score1=spinner.getSelectedItem().toString();
                score2=Integer.parseInt(score1);

                intent.putExtra("PronounciationScore",score2); //사용자 입력 점수넘겨주기
